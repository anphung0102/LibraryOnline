...
namespace LibraryOnline.Models
{
    ...
    public partial class LibraryOnlineEntities : DbContext
    {
        public LibraryOnlineEntities()
            : base("name=LibraryOnlineEntities")
        {
        ...
        public virtual DbSet<SUBJECTEBOOK> SUBJECTEBOOKs { get; set; }
        public virtual DbSet<SUBJECTESSAY> SUBJECTESSAYs { get; set; }
        public virtual DbSet<SUBJECTTHESI> SUBJECTTHESIS { get; set; }
